...
import {  FaBell, FaCog, FaDownload, FaFilter, FaSearch } from "react-icons/fa";
  ...
  return (
    ...
    <div className="flex items-center justify-between px-4 md:px-8 py-1">
      ...
      <div className="flex items-center gap-4 md:gap-6">
        <FaFilter className="text-xl text-gray-400 hover:text-pink-700 cursor-pointer" />
        <FaDownload className="text-xl text-gray-400 hover:text-pink-700 cursor-pointer" />
        <FaBell className="text-xl text-gray-400 hover:text-pink-700 cursor-pointer" />
        <FaCog className="text-xl text-gray-400 hover:text-pink-700 cursor-pointer" />
      </div>
    </div>
  </header>
  );
