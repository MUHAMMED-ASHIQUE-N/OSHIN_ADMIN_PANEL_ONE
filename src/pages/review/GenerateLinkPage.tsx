...
const GenerateLinkPage: React.FC = () => {
  ...
  const handleShare = (platform: 'whatsapp' | 'email') => {
    ...
    if (platform === 'whatsapp') {
      ...
      window.open(`mailto:?subject=Oshin Hotels Feedback&body=${message}`, '_blank');
    }
  };
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100 p-4">
      ...
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-8 space-y-6 text-center">
        ...
        <p className="text-lg text-gray-600">
          Generate a single-use review link for a <span className="font-bold text-primary">{linkCategory}</span> guest.
        </p>
        ...
        {!generatedToken ? (
          ...
          <div className="space-y-6">
            ...
            <button
              onClick={generateToken} // Re-generate
              disabled={isLoading}
